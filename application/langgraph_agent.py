...
BASE_SYSTEM_PROMPT = (
    ...
    "답변 언어: 사용자 질문이 영어이면 영어로 답하고, "
    "질문에 한국어가 포함되면 한국어로 답하세요.\n"
)
...
def _system_message_with_cache(system: str) -> SystemMessage:
    """Build a SystemMessage (cache breakpoints are unused for OpenAI GPT)."""
...
async def call_model(state: State, config):
    ...
    try:
        ...
        # Strip reasoning blocks left by OpenAI Responses API when needed.
