...
DEFAULT_GATEWAY_MODEL = "OpenAI GPT 5.6 Sol"
...
def get_config(request: Request):
    ...
    if not default_mcp:
        default_mcp = [m for m in utils.DEFAULT_MCP_SERVERS if m in mcp_options]
        logger.info("Using built-in MCP defaults: %s", default_mcp)
