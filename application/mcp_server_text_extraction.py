...
try:
    ...
    # DocGraph Sync / pdf2text only need the helpers below; MCP is optional.
...
def _get_chat():
    ...
    if model_type != "openai":
        raise ValueError(f"Unsupported model_type={model_type!r}; only OpenAI GPT is supported")
...
def _content_to_text(content: object) -> str:
    ...
    Newer Bedrock responses often return ``content`` as a list of blocks
