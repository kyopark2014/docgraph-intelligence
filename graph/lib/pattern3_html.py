...
<<<ASK_PANEL_HTML>>>
  ...
  <div class="controls">
    <div class="controls-row">
      ...
      <button type="button" class="ctrl-btn pattern-btn active" data-pattern="pattern3" onclick="selectPattern('pattern3')" title="Holistic View (current)">Holistic View</button>
    </div>
    <div class="controls-row">
